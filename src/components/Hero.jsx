        ...
        <div className="h-screen grid place-items-center" onMouseMove={handlemousemove} onMouseEnter={handlemouseenter}>
            <div>
                <div className="flex flex-col items-center justify-center gap-y-3 font-light capitalize">
                    ...
                    <h1 className='text-center text-3xl font-bold tracking-wider text-gray-500'>My name is Yoshith Maddi &</h1>
                    <p className='text-lg tracking-wider text-gray-700 sm:text-2xl'>I like programming 😀</p>
                </div>
                <div className='mt-8 flex justify-center gap-x-10 text-3xl text-yellow-600c sm:text-2xl'>
